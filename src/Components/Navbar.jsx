    ...
    return (
        <nav className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-400 text-white px-8 py-4 flex justify-between items-center shadow-lg">
            ...
            <div className="flex gap-4">
                ...
                <Link to= "/Cart" className=" bg-white text-purple-600 font-bold px-4 py-2 rounded-full hover:scale-105 transition-transform shadow-lg"><ShoppingCart /> {totalItems > 0 && <span className=" relative bg-red-500 text-white rounded-full px-2 py-1 text-sm absolute -top-2 -right-2">{totalItems}</span>}</Link>
